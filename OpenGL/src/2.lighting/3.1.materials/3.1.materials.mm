...
//                model = glm::rotate(model, glm::radians(angle), glm::vec3(1.0f, 0.3f, 0.5f));
            ...
            glm::vec3 lightStrength = glm::vec3(0.1f);
            
            ourShader.setVec3f("viewPos", glm::value_ptr(camera.Position));
            ourShader.setFloat("material.shininess", shininess);
            ourShader.setVec3f("material.specular", glm::value_ptr(specular));
            ourShader.setVec3f("material.diffuse", glm::value_ptr(diffuse));
            ourShader.setVec3f("material.ambient", glm::value_ptr(ambient));
            ...
            ourShader.setVec3f("light.strength", glm::value_ptr(lightStrength));
